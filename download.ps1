...
write-host "Downloading tactical.bat."
Invoke-WebRequest -uri https://raw.githubusercontent.com/QCTech/Win11-setup/master/tactical.bat  -outfile $baseDirectory\tactical.bat
